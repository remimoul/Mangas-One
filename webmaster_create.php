...
<head>
    ...
    <title>Mangas One - Page webmaster creation</title>
...
// $statement = $dbh->prepare("INSERT INTO mangas_one.produit (titre,prix,description,date,url_image,id_genre) VALUES(?,?,?,?,?,?)");
    ...
    $statement = $dbh->prepare("INSERT INTO mangas_one.produit (titre,prix,description,date,url_image,id_genre) VALUES(:titre, :prix, :description, :date, :photo, :categorie)");
